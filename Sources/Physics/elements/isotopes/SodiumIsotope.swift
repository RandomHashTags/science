...
public enum SodiumIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details : ChemicalElementDetails {
        ...
        case .sodium_24:
            return ChemicalElementDetails(self, neutron_count: 13, standard_atomic_weight: "23.990963012", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.hour, value: "14.9560"))
        case .sodium_24_isomer_1:
        ...
        case .sodium_25:
            return ChemicalElementDetails(self, neutron_count: 14, standard_atomic_weight: "24.9899540", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "59.1"))
        case .sodium_26:
            return ChemicalElementDetails(self, neutron_count: 15, standard_atomic_weight: "25.992635", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "1.07128"))
        case .sodium_26_isomer_1:
        ...
        case .sodium_27:
            return ChemicalElementDetails(self, neutron_count: 16, standard_atomic_weight: "26.994076", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "301"))
        case .sodium_28:
            return ChemicalElementDetails(self, neutron_count: 17, standard_atomic_weight: "27.998939", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "33.1"))
        case .sodium_29:
            return ChemicalElementDetails(self, neutron_count: 18, standard_atomic_weight: "29.002877", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "43.2"))
        case .sodium_30:
            return ChemicalElementDetails(self, neutron_count: 19, standard_atomic_weight: "30.009098", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "45.9"))
        case .sodium_31:
            return ChemicalElementDetails(self, neutron_count: 20, standard_atomic_weight: "31.013147", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "16.8"))
        case .sodium_32:
            return ChemicalElementDetails(self, neutron_count: 21, standard_atomic_weight: "32.020010", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "12.9"))
        case .sodium_33:
        ...
        case .sodium_37:
            return ChemicalElementDetails(self, neutron_count: 26, standard_atomic_weight: "37.05704", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.micro, type: TimeUnitType.second, value: "1.6"))
        case .sodium_39:
            return ChemicalElementDetails(self, neutron_count: 28, standard_atomic_weight: "39.075", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.nano, type: TimeUnitType.second, value: "401"))
        }
    }
}

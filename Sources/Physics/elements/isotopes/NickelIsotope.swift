...
public enum NickelIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details : ChemicalElementDetails {
        ...
        case .nickel_59:
            return ChemicalElementDetails(self, neutron_count: 31, standard_atomic_weight: "58.9343467", decay_mode: AtomicDecayType.electron_capture(amount: 1), half_life: TimeUnit(type: TimeUnitType.year, value: "76000"))
        case .nickel_60:
        ...
        case .nickel_63:
            return ChemicalElementDetails(self, neutron_count: 35, standard_atomic_weight: "62.9296694", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.year, value: "100.1"))
        case .nickel_63_isomer_1:
        ...
        case .nickel_65:
            return ChemicalElementDetails(self, neutron_count: 37, standard_atomic_weight: "64.9300843", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.hour, value: "2.5172"))
        case .nickel_65_isomer_1:
        ...
        case .nickel_66:
            return ChemicalElementDetails(self, neutron_count: 38, standard_atomic_weight: "65.9291393", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.hour, value: "54.6"))
        case .nickel_67:
            return ChemicalElementDetails(self, neutron_count: 39, standard_atomic_weight: "66.931569", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "21"))
        case .nickel_67_isomer_1:
            return ChemicalElementDetails(self, neutron_count: 39, standard_atomic_weight: "66.931569", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.micro, type: TimeUnitType.second, value: "13.3"))
        case .nickel_68:
            return ChemicalElementDetails(self, neutron_count: 40, standard_atomic_weight: "67.931869", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "29"))
        case .nickel_68_isomer_1:
        ...
        case .nickel_69:
            return ChemicalElementDetails(self, neutron_count: 41, standard_atomic_weight: "68.935610", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "11.5"))
        case .nickel_69_isomer_1:
            return ChemicalElementDetails(self, neutron_count: 41, standard_atomic_weight: "68.935610", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "3.5"))
        case .nickel_69_isomer_2:
        ...
        case .nickel_70:
            return ChemicalElementDetails(self, neutron_count: 42, standard_atomic_weight: "69.93650", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "6.0"))
        case .nickel_70_isomer_1:
        ...
        case .nickel_71:
            return ChemicalElementDetails(self, neutron_count: 43, standard_atomic_weight: "70.94074", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "2.56"))
        case .nickel_72:
            return ChemicalElementDetails(self, neutron_count: 44, standard_atomic_weight: "71.94209", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "1.57"))
        case .nickel_73:
            return ChemicalElementDetails(self, neutron_count: 45, standard_atomic_weight: "72.94647", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "0.84"))
        case .nickel_74:
            return ChemicalElementDetails(self, neutron_count: 46, standard_atomic_weight: "73.94807", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "0.68"))
        case .nickel_75:
            return ChemicalElementDetails(self, neutron_count: 47, standard_atomic_weight: "74.95287", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "0.6"))
        case .nickel_76:
            return ChemicalElementDetails(self, neutron_count: 48, standard_atomic_weight: "75.95533", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "470"))
        case .nickel_77:
            return ChemicalElementDetails(self, neutron_count: 49, standard_atomic_weight: "76.96055", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "300"))
        case .nickel_78:
            return ChemicalElementDetails(self, neutron_count: 50, standard_atomic_weight: "77.96318", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "120"))
        case .nickel_79:
            return ChemicalElementDetails(self, neutron_count: 51, standard_atomic_weight: "78.970400", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "43.0"))
        case .nickel_80:
            return ChemicalElementDetails(self, neutron_count: 52, standard_atomic_weight: "78.970400", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "24"))
        }
    }
}

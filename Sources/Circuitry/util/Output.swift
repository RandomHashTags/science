...
public final class Output : CircuitComponent, PowerReceiver {
    ...
    public init(id: UUID = UUID(), name: String? = nil, point: GridPoint, width: Int = 4, height: Int = 3, propagation_delay: TimeUnit, facing: Direction = Direction.east, data_bits: Int) {
        self.id = id
        self.name = name
        self.point = point
        self.width = width

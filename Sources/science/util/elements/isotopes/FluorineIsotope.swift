...
public enum FluorineIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details: ChemicalElementDetails {
        ...
        case .fluorine_20:
            return ChemicalElementDetails(self, neutron_count: 11, standard_atomic_weight: "19.99998125", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "11.0062"))
        case .fluorine_21:
            return ChemicalElementDetails(self, neutron_count: 12, standard_atomic_weight: "20.9999489", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "4.158"))
        case .fluorine_22:
            return ChemicalElementDetails(self, neutron_count: 13, standard_atomic_weight: "22.002999", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "4.23"))
        case .fluorine_23:
            return ChemicalElementDetails(self, neutron_count: 14, standard_atomic_weight: "23.003530", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "2.23"))
        case .fluorine_24:
            return ChemicalElementDetails(self, neutron_count: 15, standard_atomic_weight: "24.008100", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "384"))
        case .fluorine_25:
            return ChemicalElementDetails(self, neutron_count: 16, standard_atomic_weight: "25.012170", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "80"))
        case .fluorine_26:
            return ChemicalElementDetails(self, neutron_count: 17, standard_atomic_weight: "26.020050", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "8.2"))
        case .fluorine_26_isomer_1:

...
public enum MagnesiumIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details : ChemicalElementDetails {
        ...
        case .magnesium_19:
            return ChemicalElementDetails(self, neutron_count: 7, standard_atomic_weight: "19.034180", decay_mode: AtomicDecayType.proton_emission(amount: 2), half_life: TimeUnit(prefix: UnitPrefix.pico, type: TimeUnitType.second, value: "5"))
        case .magnesium_20:
            return ChemicalElementDetails(self, neutron_count: 8, standard_atomic_weight: "20.0187631", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "90.4"))
        case .magnesium_21:
            return ChemicalElementDetails(self, neutron_count: 9, standard_atomic_weight: "21.0117058", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "120.0"))
        case .magnesium_22:
            return ChemicalElementDetails(self, neutron_count: 10, standard_atomic_weight: "21.99957060", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(type: TimeUnitType.second, value: "3.8745"))
        case .magnesium_23:
            return ChemicalElementDetails(self, neutron_count: 11, standard_atomic_weight: "22.99412377", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(type: TimeUnitType.second, value: "11.3039"))
        case .magnesium_24:
            return ChemicalElementDetails(self, neutron_count: 12, standard_atomic_weight: "23.985041689")
        case .magnesium_25:
            return ChemicalElementDetails(self, neutron_count: 13, standard_atomic_weight: "24.98583697")
        case .magnesium_26:

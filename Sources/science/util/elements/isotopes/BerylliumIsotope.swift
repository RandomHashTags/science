...
public enum BerylliumIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details : ChemicalElementDetails {
        ...
        case .beryllium_7:
            return ChemicalElementDetails(self, neutron_count: 3, standard_atomic_weight: "7.01692871", decay_mode: AtomicDecayType.electron_capture, half_life: TimeUnit(type: TimeUnitType.day, value: "53.22"))
        case .beryllium_8:
        ...
        case .beryllium_10:
            return ChemicalElementDetails(self, neutron_count: 6, standard_atomic_weight: "10.01353469", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.year, value: "1387000")) // TODO: fix? | tropical year
        case .beryllium_11:
            return ChemicalElementDetails(self, neutron_count: 7, standard_atomic_weight: "11.02166108", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "13.76"))
        case .beryllium_11_isomer_1:
        ...
        case .beryllium_12:
            return ChemicalElementDetails(self, neutron_count: 8, standard_atomic_weight: "12.0269221", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "21.46"))
        case .beryllium_12_isomer_1:

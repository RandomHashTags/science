...
public enum SiliconIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details: ChemicalElementDetails {
        ...
        case .silicon_31:
            return ChemicalElementDetails(self, neutron_count: 17, standard_atomic_weight: "30.97536319", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.minute, value: "157.36"))
        case .silicon_32:
            return ChemicalElementDetails(self, neutron_count: 18, standard_atomic_weight: "31.9741515", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.year, value: "153"))
        case .silicon_33:
        ...
        case .silicon_36:
            return ChemicalElementDetails(self, neutron_count: 22, standard_atomic_weight: "35.98665", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "450"))
        case .silicon_37:
            return ChemicalElementDetails(self, neutron_count: 23, standard_atomic_weight: "36.99295", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "90"))
        case .silicon_38:
        ...
        case .silicon_39:
            return ChemicalElementDetails(self, neutron_count: 25, standard_atomic_weight: "39.00249", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "47.5"))
        case .silicon_40:
            return ChemicalElementDetails(self, neutron_count: 26, standard_atomic_weight: "40.00583", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "33.0"))
        case .silicon_41:
            return ChemicalElementDetails(self, neutron_count: 27, standard_atomic_weight: "41.01301", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "20.0"))
        case .silicon_42:
            return ChemicalElementDetails(self, neutron_count: 28, standard_atomic_weight: "42.01768", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "12.5"))
        case .silicon_43:

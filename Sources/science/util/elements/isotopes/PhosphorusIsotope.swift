...
public enum PhosphorusIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details : ChemicalElementDetails {
        ...
        case .phosphorus_32:
            return ChemicalElementDetails(self, neutron_count: 17, standard_atomic_weight: "31.97390764", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.day, value: "14.268"))
        case .phosphorus_33:
            return ChemicalElementDetails(self, neutron_count: 18, standard_atomic_weight: "32.9717257", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.day, value: "25.35"))
        case .phosphorus_34:
            return ChemicalElementDetails(self, neutron_count: 19, standard_atomic_weight: "33.9736459", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "12.43"))
        case .phosphorus_35:
            return ChemicalElementDetails(self, neutron_count: 20, standard_atomic_weight: "34.9733141", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "47.3"))
        case .phosphorus_36:
            return ChemicalElementDetails(self, neutron_count: 21, standard_atomic_weight: "35.978260", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "5.6"))
        case .phosphorus_37:
            return ChemicalElementDetails(self, neutron_count: 22, standard_atomic_weight: "36.97961", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "2.31"))
        case .phosphorus_38:
            return ChemicalElementDetails(self, neutron_count: 23, standard_atomic_weight: "37.98430", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(type: TimeUnitType.second, value: "0.64"))
        case .phosphorus_39:
            return ChemicalElementDetails(self, neutron_count: 24, standard_atomic_weight: "38.98629", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "282"))
        case .phosphorus_40:
            return ChemicalElementDetails(self, neutron_count: 25, standard_atomic_weight: "39.99129", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "150"))
        case .phosphorus_41:
            return ChemicalElementDetails(self, neutron_count: 26, standard_atomic_weight: "40.99465", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "101"))
        case .phosphorus_42:
        ...
        case .phosphorus_47:
            return ChemicalElementDetails(self, neutron_count: 32, standard_atomic_weight: "47.03190", decay_mode: AtomicDecayType.beta_minus(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "2"))
        }
    }
}

...
enum IronIsotope : String, ChemicalElementIsotope {
    ...
    var load_details : ChemicalElementDetails {
        ...
        case .iron_55:
            return ChemicalElementDetails(self, neutron_count: 29, standard_atomic_weight: "54.9382934", decay_mode: AtomicDecayType.electron_capture, half_life: TimeUnit(type: TimeUnitType.year, value: "2.737"))
        case .iron_56:
        ...
        case .iron_59:
            return ChemicalElementDetails(self, neutron_count: 33, standard_atomic_weight: "58.9348755", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.day, value: "44.495"))
        case .iron_60:
            return ChemicalElementDetails(self, neutron_count: 34, standard_atomic_weight: "59.934072", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.year, value: "2600000"))
        case .iron_61:
            return ChemicalElementDetails(self, neutron_count: 35, standard_atomic_weight: "60.936745", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.minute, value: "5.98"))
        case .iron_61_isomer_1:
        ...
        case .iron_62:
            return ChemicalElementDetails(self, neutron_count: 36, standard_atomic_weight: "61.936767", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "68"))
        case .iron_63:
            return ChemicalElementDetails(self, neutron_count: 37, standard_atomic_weight: "62.94037", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "6.1"))
        case .iron_64:
            return ChemicalElementDetails(self, neutron_count: 38, standard_atomic_weight: "63.9412", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "2.0"))
        case .iron_65:
            return ChemicalElementDetails(self, neutron_count: 39, standard_atomic_weight: "64.94538", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "1.3"))
        case .iron_65_isomer_1:
        ...
        case .iron_66:
            return ChemicalElementDetails(self, neutron_count: 40, standard_atomic_weight: "65.94678", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "440"))
        case .iron_67:
            return ChemicalElementDetails(self, neutron_count: 41, standard_atomic_weight: "66.95095", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "394"))
        case .iron_67_isomer_1:
        ...
        case .iron_68:
            return ChemicalElementDetails(self, neutron_count: 42, standard_atomic_weight: "67.95370", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "187"))
        case .iron_69:
            return ChemicalElementDetails(self, neutron_count: 43, standard_atomic_weight: "68.95878", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "109"))
        case .iron_70:

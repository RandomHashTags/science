...
public enum CobaltIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details : ChemicalElementDetails {
        ...
        case .cobalt_57:
            return ChemicalElementDetails(self, neutron_count: 30, standard_atomic_weight: "56.9362914", decay_mode: AtomicDecayType.electron_capture, half_life: TimeUnit(type: TimeUnitType.day, value: "271.74"))
        case .cobalt_58:
        ...
        case .cobalt_61:
            return ChemicalElementDetails(self, neutron_count: 34, standard_atomic_weight: "60.9324758", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.hour, value: "1.650"))
        case .cobalt_62:
            return ChemicalElementDetails(self, neutron_count: 35, standard_atomic_weight: "61.934051", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.minute, value: "1.50"))
        case .cobalt_62_isomer_1:
            return ChemicalElementDetails(self, neutron_count: 35, standard_atomic_weight: "61.934051", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.minute, value: "13.91"))
        case .cobalt_63:
            return ChemicalElementDetails(self, neutron_count: 36, standard_atomic_weight: "62.933612", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "26.9"))
        case .cobalt_64:
            return ChemicalElementDetails(self, neutron_count: 37, standard_atomic_weight: "63.935810", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "0.30"))
        case .cobalt_65:
            return ChemicalElementDetails(self, neutron_count: 38, standard_atomic_weight: "64.936478", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "1.20"))
        case .cobalt_66:
            return ChemicalElementDetails(self, neutron_count: 39, standard_atomic_weight: "65.93976", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "0.18"))
        case .cobalt_66_isomer_1:
        ...
        case .cobalt_67:
            return ChemicalElementDetails(self, neutron_count: 40, standard_atomic_weight: "66.94089", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "0.425"))
        case .cobalt_68:
            return ChemicalElementDetails(self, neutron_count: 41, standard_atomic_weight: "67.94487", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "0.199"))
        case .cobalt_68_isomer_1:
        ...
        case .cobalt_69:
            return ChemicalElementDetails(self, neutron_count: 42, standard_atomic_weight: "68.94632", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "227"))
        case .cobalt_70:
            return ChemicalElementDetails(self, neutron_count: 43, standard_atomic_weight: "69.9510", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "119"))
        case .cobalt_70_isomer_1:
        ...
        case .cobalt_71:
            return ChemicalElementDetails(self, neutron_count: 44, standard_atomic_weight: "70.9529", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "97"))
        case .cobalt_72:
            return ChemicalElementDetails(self, neutron_count: 45, standard_atomic_weight: "71.95781", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "62"))
        case .cobalt_73:

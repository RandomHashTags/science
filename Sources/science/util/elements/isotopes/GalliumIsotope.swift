...
public enum GalliumIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details : ChemicalElementDetails {
        ...
        case .gallium_67:
            return ChemicalElementDetails(self, neutron_count: 36, standard_atomic_weight: "66.9282017", decay_mode: AtomicDecayType.electron_capture, half_life: TimeUnit(type: TimeUnitType.day, value: "3.2612"))
        case .gallium_68:
        ...
        case .gallium_70:
            return ChemicalElementDetails(self, neutron_count: 39, standard_atomic_weight: "69.9260220", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.minute, value: "21.14"))
        case .gallium_71:
            return ChemicalElementDetails(self, neutron_count: 40, standard_atomic_weight: "70.9247013")
        case .gallium_72:
            return ChemicalElementDetails(self, neutron_count: 41, standard_atomic_weight: "71.9263663", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.hour, value: "14.095"))
        case .gallium_72_isomer_1:
        ...
        case .gallium_73:
            return ChemicalElementDetails(self, neutron_count: 42, standard_atomic_weight: "72.9251747", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.hour, value: "4.86"))
        case .gallium_74:
            return ChemicalElementDetails(self, neutron_count: 43, standard_atomic_weight: "73.926946", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.minute, value: "8.12"))
        case .gallium_74_isomer_1:
        ...
        case .gallium_75:
            return ChemicalElementDetails(self, neutron_count: 44, standard_atomic_weight: "74.9265002", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "126"))
        case .gallium_76:
            return ChemicalElementDetails(self, neutron_count: 45, standard_atomic_weight: "75.9288276", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "32.6"))
        case .gallium_77:
            return ChemicalElementDetails(self, neutron_count: 46, standard_atomic_weight: "76.9291543", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "13.2"))
        case .gallium_78:
            return ChemicalElementDetails(self, neutron_count: 47, standard_atomic_weight: "77.9316082", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "5.09"))
        case .gallium_79:
            return ChemicalElementDetails(self, neutron_count: 48, standard_atomic_weight: "78.93289", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "2.847"), decays_into_isomer: 1)
        case .gallium_80:
            return ChemicalElementDetails(self, neutron_count: 49, standard_atomic_weight: "79.93652", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "1.697"))
        case .gallium_81:
            return ChemicalElementDetails(self, neutron_count: 50, standard_atomic_weight: "80.93775", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "1.217"), decays_into_isomer: 1)
        case .gallium_82:
            return ChemicalElementDetails(self, neutron_count: 51, standard_atomic_weight: "81.94299", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "0.599"))
        case .gallium_83:
            return ChemicalElementDetails(self, neutron_count: 52, standard_atomic_weight: "82.94698", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "308"))
        case .gallium_84:

...
public enum CopperIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details : ChemicalElementDetails {
        switch self {
        case .copper_52:
            return ChemicalElementDetails(self, neutron_count: 23, standard_atomic_weight: "51.99718", decay_mode: AtomicDecayType.proton_emission(amount: 1), half_life: nil) // TODO: fix
        case .copper_53:
            return ChemicalElementDetails(self, neutron_count: 24, standard_atomic_weight: "52.98555", decay_mode: AtomicDecayType.proton_emission(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.nano, type: TimeUnitType.second, value: "299"))
        case .copper_54:
            return ChemicalElementDetails(self, neutron_count: 25, standard_atomic_weight: "53.97671", decay_mode: AtomicDecayType.proton_emission(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.nano, type: TimeUnitType.second, value: "74"))
        case .copper_55:
            return ChemicalElementDetails(self, neutron_count: 26, standard_atomic_weight: "54.96605", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "40"))
        case .copper_56:
            return ChemicalElementDetails(self, neutron_count: 27, standard_atomic_weight: "55.95856", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "93"))
        case .copper_57:
            return ChemicalElementDetails(self, neutron_count: 28, standard_atomic_weight: "56.949211", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "196.3"))
        case .copper_58:
            return ChemicalElementDetails(self, neutron_count: 29, standard_atomic_weight: "57.9445385", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(type: TimeUnitType.second, value: "3.204"))
        case .copper_59:
            return ChemicalElementDetails(self, neutron_count: 30, standard_atomic_weight: "58.9394980", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(type: TimeUnitType.second, value: "81.5"))
        case .copper_60:
            return ChemicalElementDetails(self, neutron_count: 31, standard_atomic_weight: "59.9373650", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(type: TimeUnitType.minute, value: "23.7"))
        case .copper_61:
            return ChemicalElementDetails(self, neutron_count: 32, standard_atomic_weight: "60.9334578", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(type: TimeUnitType.hour, value: "3.333"))
        case .copper_62:
            return ChemicalElementDetails(self, neutron_count: 33, standard_atomic_weight: "61.932584", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(type: TimeUnitType.minute, value: "9.673"))
        case .copper_63:
            return ChemicalElementDetails(self, neutron_count: 34, standard_atomic_weight: "62.9295975")
        case .copper_64:
            return ChemicalElementDetails(self, neutron_count: 35, standard_atomic_weight: "63.9297642", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(type: TimeUnitType.hour, value: "12.700"))
        case .copper_65:

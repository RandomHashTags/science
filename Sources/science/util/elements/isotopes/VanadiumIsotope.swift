...
public enum VanadiumIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details : ChemicalElementDetails {
        switch self {
        case .vanadium_40:
            return ChemicalElementDetails(self, neutron_count: 17, standard_atomic_weight: "40.01109", decay_mode: AtomicDecayType.proton_emission(amount: 1), half_life: nil) // TODO: fix
        case .vanadium_41:
            return ChemicalElementDetails(self, neutron_count: 18, standard_atomic_weight: "40.99978", decay_mode: AtomicDecayType.proton_emission(amount: 1), half_life: nil) // TODO: fix
        case .vanadium_42:
            return ChemicalElementDetails(self, neutron_count: 19, standard_atomic_weight: "41.99123", decay_mode: AtomicDecayType.proton_emission(amount: 1), half_life: TimeUnit(prefix: UnitPrefix.nano, type: TimeUnitType.second, value: "54"))
        case .vanadium_43:
            return ChemicalElementDetails(self, neutron_count: 20, standard_atomic_weight: "42.98065", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "80"))
        case .vanadium_44:
            return ChemicalElementDetails(self, neutron_count: 21, standard_atomic_weight: "43.97411", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "111"))
        case .vanadium_44_isomer_1:
            return ChemicalElementDetails(self, neutron_count: 21, standard_atomic_weight: "43.97411", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "150"))
        case .vanadium_45:
            return ChemicalElementDetails(self, neutron_count: 22, standard_atomic_weight: "44.965776", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "547"))
        case .vanadium_46:
            return ChemicalElementDetails(self, neutron_count: 23, standard_atomic_weight: "45.9602005", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "422.50"))
        case .vanadium_46_isomer_1:
            return ChemicalElementDetails(self, neutron_count: 23, standard_atomic_weight: "45.9602005", decay_mode: AtomicDecayType.isomeric_transition, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "1.02"))
        case .vanadium_47:
            return ChemicalElementDetails(self, neutron_count: 24, standard_atomic_weight: "46.9549089", decay_mode: AtomicDecayType.beta_plus, half_life: TimeUnit(type: TimeUnitType.minute, value: "32.6"))
        case .vanadium_48:

...
public enum TitaniumIsotope : String, ChemicalElementIsotope {
    ...
    public var load_details : ChemicalElementDetails {
        ...
        case .titanium_44:
            return ChemicalElementDetails(self, neutron_count: 22, standard_atomic_weight: "43.9596901", decay_mode: AtomicDecayType.electron_capture, half_life: TimeUnit(type: TimeUnitType.year, value: "60.0"))
        case .titanium_45:
        ...
        case .titanium_51:
            return ChemicalElementDetails(self, neutron_count: 29, standard_atomic_weight: "50.946615", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.minute, value: "5.76"))
        case .titanium_52:
            return ChemicalElementDetails(self, neutron_count: 30, standard_atomic_weight: "51.946897", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.minute, value: "1.7"))
        case .titanium_53:
            return ChemicalElementDetails(self, neutron_count: 31, standard_atomic_weight: "52.94973", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "32.7"))
        case .titanium_54:
            return ChemicalElementDetails(self, neutron_count: 32, standard_atomic_weight: "53.95105", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(type: TimeUnitType.second, value: "1.5"))
        case .titanium_55:
            return ChemicalElementDetails(self, neutron_count: 33, standard_atomic_weight: "54.95527", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "490"))
        case .titanium_56:
            return ChemicalElementDetails(self, neutron_count: 34, standard_atomic_weight: "55.95820", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "164"))
        case .titanium_57:
            return ChemicalElementDetails(self, neutron_count: 35, standard_atomic_weight: "56.96399", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "60"))
        case .titanium_58:
            return ChemicalElementDetails(self, neutron_count: 36, standard_atomic_weight: "57.96697", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "54"))
        case .titanium_59:
            return ChemicalElementDetails(self, neutron_count: 37, standard_atomic_weight: "58.97293", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "30"))
        case .titanium_60:
            return ChemicalElementDetails(self, neutron_count: 38, standard_atomic_weight: "59.97676", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "22"))
        case .titanium_61:
            return ChemicalElementDetails(self, neutron_count: 39, standard_atomic_weight: "60.98320", decay_mode: AtomicDecayType.beta_minus, half_life: TimeUnit(prefix: UnitPrefix.milli, type: TimeUnitType.second, value: "10"))
        case .titanium_62:

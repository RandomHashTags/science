...
public enum ChemicalElement : String, CaseIterable {
    ...
    private func get_details(atomic_number: Int, symbol: String, standard_atomic_weight: Float, density: String, melting_point: String?, boiling_point: String?) -> ChemicalElementDetails {
